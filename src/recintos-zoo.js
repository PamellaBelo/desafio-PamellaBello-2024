class RecintosZoo {
    ...
    analisaRecintos(animal, quantidade) {
        ...
        let recintos = {
            "Recinto 1": {"espaço livre": 7, "espaço total": 10, "animais":[MACACO]},     
            "Recinto 2": {"espaço livre": 5, "espaço total": 5, "animais":[]},              
            "Recinto 3": {"espaço livre": 5, "espaço total": 7, "animais":[GAZELA]},      
            "Recinto 4": {"espaço livre": 8, "espaço total": 8, "animais":[]},             
            "Recinto 5": {"espaço livre": 6, "espaço total": 9, "animais":[LEAO]}         
        }
